...
var convertToGramsButton = document.getElementById("convertToGramsButton");
var convertToOuncesButton = document.getElementById("convertToOuncesButton");
...
function convertToGrams() {
    var value1 = weightInput.value;
    var result = parseInt(value1) * 28.34952;
